...
public class RRCreativeModeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TAB = REGISTRY.register("example_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((_, output) -> output.acceptAll(List.of(
                    ...
                    RRBlocks.ELDEN_STAIRS.toStack(),
                    RRBlocks.ELDEN_SLAB.toStack(),
                    RRBlocks.ELDEN_FENCE.toStack(),
                    RRBlocks.ELDEN_FENCE_GATE.toStack(),
                    RRBlocks.ELDEN_DOOR.toStack(),
                    RRBlocks.ELDEN_TRAPDOOR.toStack(),
                    RRBlocks.ELDEN_PRESSURE_PLATE.toStack(),
                    RRBlocks.ELDEN_BUTTON.toStack(),
                    RRBlocks.ELDEN_SIGN.toStack(),
                    RRBlocks.ELDEN_HANGING_SIGN.toStack(),
                    ...
                    RRBlocks.BAOBAB_LEAVES.toStack(),
